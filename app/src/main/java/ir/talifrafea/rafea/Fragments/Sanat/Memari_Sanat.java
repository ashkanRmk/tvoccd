...
public class Memari_Sanat extends Fragment {
                ...
                dialogBuilder
                        ...
                        .setButton1Click(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                List<Item_Model> item_models = activity.MemariParent.get(groupPosition).getMyChilds().get(childPosition).getMyItems();
    ...
    private void prepareListData() {
        ...
        List<Parent_Model> main = activity.MemariParent;
